      ...
      <header className="border-b border-white/5 sticky top-0 z-30 bg-zinc-950/90 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5" data-testid="public-home-logo">
            ...
            <span className="font-semibold tracking-tight">Stepkai</span>
          </Link>
          <div className="text-xs text-zinc-500 hidden sm:block">
            browsing as guest · sign in to unlock progress
          </div>
          <div className="flex items-center gap-2">
            <Link to="/signin" data-testid="public-signin" className="text-sm text-zinc-300 hover:text-zinc-50 px-3 py-1.5">Sign in</Link>
            <Link to="/signin" data-testid="public-cta"
              className="text-xs sm:text-sm font-semibold uppercase tracking-[0.14em] px-3 sm:px-4 py-2 rounded-md text-white hover:opacity-90 transition-opacity"
