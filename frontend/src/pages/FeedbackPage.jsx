  ...
  if (done) {
    return (
      <div className="min-h-screen bg-zinc-950 text-zinc-50 flex flex-col items-center justify-center px-4">
        ...
        <Link to="/app/questions" className="text-sm font-semibold uppercase tracking-[0.14em] px-5 py-2.5 rounded-md text-white hover:opacity-90 transition-opacity" style={{ background: 'var(--accent)' }}>
          Back to questions
        </Link>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
        <Link to="/app/questions" className="inline-flex items-center gap-1 text-xs text-zinc-500 hover:text-zinc-300 mb-8">
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-zinc-900 border border-white/10 rounded-lg px-4 py-3 text-sm text-zinc-100 placeholder:text-zinc-600 focus:outline-none focus:border-blue-500/40 resize-y"
            />
          ...
          {/* Star rating */}
          <div>
            <label className="block text-xs uppercase tracking-[0.18em] text-zinc-500 mb-3">
          ...
          <button
            ...
            className="w-full text-sm font-semibold uppercase tracking-[0.14em] px-5 py-3 rounded-md text-white hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
