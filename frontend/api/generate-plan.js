...
Each day MUST have:
- outcome: the single capability the candidate will own by end of day (measurable).
- task: ONE concrete practical task naming the exact concept/algorithm/system.
- successCriteria: how they know they hit the outcome (a test they can self-run).
- avoid: the specific trap or shortcut that wastes time or creates false confidence.
- estimatedTime: realistic time budget (e.g. "90 min").

Rules:
- BAD: "Learn Kafka". GOOD: "Explain Kafka partitions, replication, consumer groups, ISR and retention; build a producer-consumer demo that survives a broker kill."
...
{"successProbability":"<e.g. 72%>","days":[{"day":1,"focus":"<skill>","theme":"<theme>","outcome":"<measurable capability owned by end of day>","task":"<one concrete task naming the exact concept>","successCriteria":"<self-runnable test proving the outcome>","avoid":"<specific trap to avoid>","estimatedTime":"<e.g. 90 min>","practiceQuestions":["<q>"],"mockInterview":null}],"mockInterviews":[{"day":5,"type":"Coding Mock","topics":["<skill>"],"duration":"60 min"}]}
- 14 days exactly. Every day must include outcome, task, successCriteria, avoid, estimatedTime.`;
